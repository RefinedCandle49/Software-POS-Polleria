    ...
    <%@ page contentType="text/html;charset=UTF-8" language="java" %>
        <%@page import="model.Usuario, dao.UsuarioDao, java.util.*" %>
            <%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
                ...
                <body>
                    <% HttpSession sesion=request.getSession(false); String contextPath=request.getContextPath(); if
                        (sesion==null || sesion.getAttribute("usuario")==null) {
                        response.sendRedirect(request.getContextPath() + "/index.jsp" ); return; } String
                        emailRol=(String) ((Usuario) sesion.getAttribute("usuario")).getEmail(); String
                        nombreRol=(String) ((Usuario) sesion.getAttribute("usuario")).getRol();
                                        ...
                                        <header class="col-auto col-2 col-sm-4 col-md-3 col-xl-2 px-sm-2 px-0 bg-dark">
                                            <nav
                                                ...
                                                <ul class="nav flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start"
                                                    ...
                                                    <li class="nav-item pb-4">
                                                        <a href="${pageContext.request.contextPath}/admin/reportes/ventas.jsp"
                                                            class="link-inactive align-middle px-0">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                height="24" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                            ...
                                            <section>
                                                ...
                                                <div class="d-flex align-items-center justify-content-end">
                                                    <a href="${pageContext.request.contextPath}/admin/registrar.jsp"
                                                        class="link-register text-dark pb-2">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <button
                                                                                ...
                                                                                class="btn btn-dark">Mostrar</button>
                                                                        </td>
                                                                        <td>${user.getRol()}</td>
                                                                        <td>
                                                                            <c:choose>
