                ...
                <div class="d-flex justify-content-between w-100 my-2">
                    <div>
                        <a class="btn btn-primary mt-2"
                           href="${pageContext.request.contextPath}/admin/register/producto.jsp">Agregar
                            Producto</a>
                    </div>
                    <div>
                        <a class="btn btn-warning text-light mt-2"
                           href="${pageContext.request.contextPath}/admin/categorias.jsp">Gestionar
                            Categorias</a>
                    </div>
                </div>
