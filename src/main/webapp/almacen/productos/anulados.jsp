                                        ...
                                        <c:forEach items="${list}" var="prod">
                                            <tr>
                                                ...
                                                <td>
                                                            ...
                                                            <a class="btn btn-warning mx-1 text-white" id="btnActivar${prod.getIdProducto()}" data-form-id="formActivarProducto${prod.getIdProducto()}">
                ...
                btnActivar.forEach(function (btn) {
                    btn.addEventListener('click', function () {
                        ...
                        Swal.fire({
                            ...
                            html: "Esta acción activará el producto del sistema",
                            icon: "warning",
