    ...
    <div class="row vh-100 overflow-auto">
        <header class="col-auto col-2 col-sm-4 col-md-3 col-xl-3 col-xxl-2 px-sm-2 px-0 bg-dark sticky-top">
            <nav class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 min-vh-100">
                ...
                <div class="w-100 text-center text-light">
                    <img src="${pageContext.request.contextPath}/img/user-icon.png" class="img-fluid img-css py-3"
                         alt="..."/>
                    <br/><span class="d-none d-sm-inline w-100"><%= nombreRol %></span>
                    <br/><span class="d-none d-sm-inline w-100"
                               style="opacity: 0.5; word-break: break-all !important;"><%= emailRol %></span>
                </div>
                <hr>
                
                <ul class="nav flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    <li class="nav-item pb-4">
                        <a href="${pageContext.request.contextPath}/almacen/productos.jsp?page=1"
                    ...
                    <li class="pb-4">
                        <a href="${pageContext.request.contextPath}/almacen/productos/anulados.jsp?page=1"
                    ...
                    <div class="container table-responsive">
                        ...
                        <table class="table mb-3">
                            ...
                            <tr>
                                <th>Nombre:</th>
                                <td>
                                    <input maxlength="50" type="text" name="nombre" id="nombre" class="form-control"
                                           value="${param.nombre != null ? param.nombre : ''}" required
                                           onkeypress="return validarEspacios(event)">
                            ...
                            <tr>
                                <th>Descripción:</th>
                                <td>
                                    <textarea maxlength="200" name="descripcion" id="descripcion" class="form-control"
                                              required
                                              onkeypress="return validarEspacios(event)">${param.descripcion != null ? param.descripcion : '---'}</textarea>
                            ...
                            <tr>
                                <th>Precio:</th>
                                <td>
                                    <input type="number" id="precio" min="1" max="999.99" step="any"
                                           pattern="^\d*(\.\d{0,2})?$" name="precio" class="form-control"
                                           value="${param.precio != null ? param.precio : ''}" required
                            ...
                            <tr>
                                <th>Stock:</th>
                                <td>
                                    <input type="text" id="stock" maxlength="3" name="stock" class="form-control"
                                           value="${param.stock != null ? param.stock : ''}" required
